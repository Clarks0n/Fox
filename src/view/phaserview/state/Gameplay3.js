var gameplayState = {
    ...
    create: function() {
        ...
        this._backgroundClass.create();
         ...
         if (this.game.device.desktop) {
            this._buttonClass = new buttonClass3(this.game, this._buttonGroup);
            this._buttonClass.create();

            this._informationClass = new informationClass(this.game, this._informationGroup);
            this._informationClass.create(404, 605);
        } else {
            this._buttonClass = new buttonMobileClass3(this.game, this._buttonGroup);
            this._buttonClass.create();
    ...
    this.game.time.events.add(1000, this.realPrepareStop,this);
      
    /////////////////////////////
    // this._reelClass.prepareStop();
    },

    realPrepareStop:function(){
        this._reelClass.prepareStop();
    },
    ...
    addFoxRandomPrize: function(value) {
        ...
        this._foxRandomPrizeClass = new foxRandomPrizeClass2(this.game, this._foxRandomPrizeGroup);
