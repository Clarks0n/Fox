var buttonClass2 = function(engine, group) {
    this._engine = engine;
    this._group = group;
    ...
    this.create = function() {
        ...
        // BUTTON MAXBET
        this._btnMaxbet = new Phaser.Button(this._engine, GlobalClass.getPosX(1060), GlobalClass.getPosY(670), 'assetbottom', null, this, 'button_maxbet_0002.png', 'button_maxbet_0001.png', 'button_maxbet_0003.png');
        ...
        this._sprMaxbetDisable = new Phaser.Sprite(this._engine, this._btnMaxbet.x, this._btnMaxbet.y, 'assetbottom', 'button_maxbet_0003.png');
        ...
        this._valueCoins = new Phaser.Text(this._engine, this._imgColcoins.x, this._imgColcoins.y + 3, GlobalClass.GAME_BALANCE, this._style1);
        this._valueCoins.anchor.set(0.5, 0.5);
        this._grpNormal.addChild(this._valueCoins);
        ...
        this._valueCoin = new Phaser.Text(this._engine, this._imgColumnCoin.x, this._imgColumnCoin.y + 3, GlobalClass.GAME_COIN_VALUE[GlobalClass.GAME_COIN_POS], this._style1);
        ...
        this._valueBet = new Phaser.Text(this._engine, this._imgColumnBet.x ,this._imgColumnBet.y + 3, GlobalClass.GAME_BET, this._style1);
        ...
        this._valueColumnTotalBet = new Phaser.Text(this._engine, this._imgColumnTotalBet.x, this._imgColumnTotalBet.y + 3, GlobalClass.totalBet(), this._style1);
        this._valueColumnTotalBet.anchor.set(0.5, 0.5);
        this._grpNormal.addChild(this._valueColumnTotalBet);


        // MODE FEATURE
        this._sprColumnL = new Phaser.Image(this._engine, GlobalClass.getPosX(500), GlobalClass.getPosY(640), 'assetbottom', 'column_value_feature.png');
        this._grpFeature.addChild(this._sprColumnL);
        this._sprColumnR = new Phaser.Image(this._engine, GlobalClass.getPosX(800), GlobalClass.getPosY(640), 'assetbottom', 'column_value_feature.png');
        ...
        this._valueTotalBet = new Phaser.Text(this._engine, GlobalClass.getPosX(800), GlobalClass.getPosY(695), "Total Bet: " + "$ " + numeral(GlobalClass.totalBet()).format('0,0'), this._style3);
        this._groupButton.addChild(this._valueTotalBet);

        this._valueWin = new Phaser.Text(this._engine, GlobalClass.getPosX(600), GlobalClass.getPosY(695), "Win: $ 0", this._style3);
    ...
    this.setTotalBetColumn = function(){
        this._valueColumnTotalBet.text = GlobalClass.totalBet();
    };

    this.setBalance = function() {
        this._valueBalance.text = "Balance: " + "$ " + numeral(GlobalClass.GAME_BALANCE).format('0,0');
        this._valueCoins.text = GlobalClass.GAME_BALANCE;
    };
    ...
    this.tweenVolumeSlider = function() {
        ...
        sliderMaskleft.drawRect(GlobalClass.getPosX(this._volumeBase.x - 30), GlobalClass.getPosY(this._volumeBase.y), 30, 160);
        ...
        sliderMaskRight.drawRect(GlobalClass.getPosX(this._volumeBase.x + 27), GlobalClass.getPosY(this._volumeBase.y), 300, 160);
        ...
        sliderMaskTop.drawRect(GlobalClass.getPosX(this._volumeBase.x), GlobalClass.getPosY(this._volumeBase.y - 30), 50, 30);
