var buttonMobileClass2 = function(engine, group) {
    this._engine = engine;
    this._group = group;
    ...
    this.drawButton = function(){
      ...
      this._frameButton = new Phaser.Sprite(this._engine, GlobalClass.getPosX(1140), GlobalClass.getPosY(372), 'assetbottommobile', 'frame_button.png');
    ...
    this.createLandscape = function(){
      ...
      this._frameButton.y = 372;
      if(this._frameButton.angle < 0) {
         this._frameButton.angle += 90;
      }
      ...
      // COLUMN TOP
      this._valueCoins =  new Phaser.Text(this._engine, GlobalClass.getPosX(270), GlobalClass.getPosY(640), "Coins: " + GlobalClass.GAME_BALANCE, this._style1);
      this._grpSpecial.addChild(this._valueCoins);

      this._valueCoin = new Phaser.Text(this._engine, GlobalClass.getPosX(490), GlobalClass.getPosY(640), "Coin Value: " + GlobalClass.GAME_COIN_VALUE[GlobalClass.GAME_COIN_POS], this._style1);
      this._grpSpecial.addChild(this._valueCoin);

      this._valueBet = new Phaser.Text(this._engine, GlobalClass.getPosX(700), GlobalClass.getPosY(640), "Bet: " + GlobalClass.GAME_BET, this._style1);
      this._grpSpecial.addChild(this._valueBet);

      this._valueTotalBetTop = new Phaser.Text(this._engine, GlobalClass.getPosX(810), GlobalClass.getPosY(640), "Total Bet: " + GlobalClass.totalBet(), this._style1);
      this._grpSpecial.addChild(this._valueTotalBetTop);

      //COLUMN BOTTOM
      this._valueBalance = new Phaser.Text(this._engine, GlobalClass.getPosX(300), GlobalClass.getPosY(685), "Balance: " + "$ " +  numeral(GlobalClass.GAME_BALANCE).format('0,0'), this._style3);
      this._groupButton.addChild(this._valueBalance);

      this._valueTotalBet = new Phaser.Text(this._engine, GlobalClass.getPosX(920), GlobalClass.getPosY(685),"Total Bet: " + "$ " + numeral(GlobalClass.totalBet()).format('0,0'), this._style3);
      this._groupButton.addChild(this._valueTotalBet);

      if(this._holderValueWin == undefined){
          this._valueWin = new Phaser.Text(this._engine, GlobalClass.getPosX(620), GlobalClass.getPosY(685), "Win: $ 0", this._style3);
          this._groupButton.addChild(this._valueWin);
        } else {
          if(!GlobalClass.GAME_FEATURE){
            this._valueWin = new Phaser.Text(this._engine, GlobalClass.getPosX(620), GlobalClass.getPosY(685), "Win: $ " + this._holderValueWin, this._style3);
            this._groupButton.addChild(this._valueWin);
          } else {
    ...
    this.createPortrait = function(){
      ...
      // COLUMN TOP
      this._valueTotalBet =  new Phaser.Text(this._engine, GlobalClass.getPosX(78), GlobalClass.getPosY(770), "TOTAL BET: "  + GlobalClass.totalBet(), this._style6);
      this._grpSpecial.addChild(this._valueTotalBet);

      if(this._holderValueWin == undefined){
        this._valueWin = new Phaser.Text(this._engine, GlobalClass.getPosX(420), GlobalClass.getPosY(770), "WIN: 0", this._style6);
        this._grpSpecial.addChild(this._valueWin);
      } else {
        this._valueWin = new Phaser.Text(this._engine, GlobalClass.getPosX(420), GlobalClass.getPosY(770), "WIN: " + this._holderValueWin, this._style6);
        this._grpSpecial.addChild(this._valueWin);;
      }

      //COLUMN BOTTOM
      this._valueCoinPor = new Phaser.Text(this._engine, GlobalClass.getPosX(160), GlobalClass.getPosY(826), "Coin Value: " + "$" +  GlobalClass.GAME_COIN_VALUE[GlobalClass.GAME_COIN_POS], this._style1);
      this._groupButton.addChild(this._valueCoinPor);

      this._valueBet = new Phaser.Text(this._engine, GlobalClass.getPosX(430), GlobalClass.getPosY(826),"Bet: " + "$ " + numeral(GlobalClass.totalBet()).format('0,0'), this._style1);
      this._groupButton.addChild(this._valueBet);

      this._valueBalance = new Phaser.Text(this._engine, GlobalClass.getPosX(220), GlobalClass.getPosY(870), "Balance: " + "$ " +  numeral(GlobalClass.GAME_BALANCE).format('0,0'), this._style5);
      this._groupButton.addChild(this._valueBalance);
      ...
      // BUTTON SPIN SKIP SIDEBET
      this._frameButton.x = this._engine.world.centerX + 75;
      this._frameButton.y = 1050;
      this._frameButton.angle -= 90;
      this._btnSideBetOn.x = this._frameButton.x + 120;
      this._btnSideBetOn.y = this._frameButton.y;
      this._btnSideBetOff.x = this._frameButton.x + 120;
      this._btnSideBetOff.y = this._frameButton.y;
  ...
  this.checkSprTransparent = function(){
    ...
    this.setOption = function() {
      ...
      if(this._engine.scale.isLandscape){
        ...
        var posBetX = this._betLandScapeMaxPos - Math.ceil((this._betLandScapeMaxPos - this._betLandScapeMinPos) * GlobalClass.GAME_BET / GlobalClass.GAME_BET_MAX);
        ...
        //TOP VALUE
        this._valueTotalBetOption = new Phaser.Text(this._engine, this._betSettingScreen.x + 185, this._betSettingScreen.y + 245, numeral(GlobalClass.totalBet()).format('0,0'), betSettingStyle);
        this._valueTotalBetOption.anchor.setTo(0.5, 0.5);
        this._groupOption.addChild(this._valueTotalBetOption);

        this._valueCoinOption = new Phaser.Text(this._engine, this._betSettingScreen.x + 530, this._betSettingScreen.y + 245, numeral(GlobalClass.GAME_COIN_VALUE[GlobalClass.GAME_COIN_POS]).format('0,0'), betSettingStyle);
        this._valueCoinOption.anchor.setTo(0.5, 0.5);
        this._groupOption.addChild(this._valueCoinOption);
        ...
        this._txtSliderBet = new Phaser.Text(this._engine, this._btnSliderBet.x - 55, this._btnSliderBet.y + 3, this._betValueCarry, betSettingStyle2);
        this._txtSliderBet.anchor.setTo(0.5, 0.5);
        this._groupOption.addChild(this._txtSliderBet);
        ...
        var posBetY = this._betPortraitMaxPos - Math.ceil((this._betPortraitMaxPos - this._betPortraitMinPos) * GlobalClass.GAME_BET / GlobalClass.GAME_BET_MAX);
    ...
    this.onSliderBetDragUpdate = function() {
        ...
        if(this._engine.scale.isLandscape){
          ...
          this._betValueCarry = Math.floor(percentage * (GlobalClass.GAME_BET_MAX - GlobalClass.GAME_BET_MIN) / 100) + 1;
    ...
    this.setCoin = function() {
      if(this._engine.scale.isLandscape){
        ...
        this._valueCoinPor.text = "Coin value: " + "$" + GlobalClass.GAME_COIN_VALUE[GlobalClass.GAME_COIN_POS];
        this._valueCoinOption.text = GlobalClass.GAME_COIN_VALUE[GlobalClass.GAME_COIN_POS];
      }
    ...
    this.setBet = function() {
      if(this._engine.scale.isLandscape){
        this._valueBet.text = "Bet: " + GlobalClass.GAME_BET;
      } else {
        this._valueBet.text = "Bet: " + "$" + GlobalClass.GAME_BET;
      }
    };
    ...
    this.setTotalBet = function() {
      if(this._engine.scale.isLandscape){
        this._valueTotalBetTop.text = "Total Bet: " + GlobalClass.totalBet();
        this._valueTotalBet.text = "Total Bet: " + "$ " + numeral(GlobalClass.totalBet()).format('0,0');
        if(this._valueTotalBetOption != null){
          this._valueTotalBetOption.text = numeral(GlobalClass.totalBet()).format('0,0');
        } 
      } else {
        this._valueTotalBet.text = "TOTAL BET " + GlobalClass.totalBet();
        if(this._valueTotalBetOption != null){
        this._valueTotalBetOption.text = numeral(GlobalClass.totalBet()).format('0,0');
       }
      }
    ...
    this.setBalance = function() {
      if(this._engine.scale.isLandscape){
        ...
        this._valueCoins.text = "Coins: " + GlobalClass.GAME_BALANCE;
      } else {
        this._valueBalance.text = "Balance: " + "$ "  + numeral(GlobalClass.GAME_BALANCE).format('0,0');
      }
