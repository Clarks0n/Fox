var foxSideBarClassPortrait = function(engine, group) {
    this._engine = engine;
    this._group = group;
    ...
    this.drawSideBar = function() {
        this._sideBar = this._engine.add.sprite(this._startPosX, this._startPosY,'assetgameplay2','multiplierframe_potrait.png',this._groupSideBar);
        ...
        this._sideBarMask.drawRect(225 , 192 , 314, 71);
    ...
    this.drawFoxGirlSit = function(){
        this._sprFoxGirl = new Phaser.Sprite(this._engine, GlobalClass.getPosX(-30), GlobalClass.getPosY(15), 'prinfeature', 'FeatureFoxyPrincess_00.png');
        this._groupGirl.addChild(this._sprFoxGirl);
        this._sprFoxGirl.scale.set(0.65,0.65);
    ...
    this.drawFoxGirlThrow = function(){
        ...
        this._sprFoxGirlThrow.scale.set(0.65,0.65);
    ...
    this.drawDataBall = function() {
        ...
        this._orbSmall = new Phaser.Sprite(this._engine, 233, 218, 'assetfreegames2', orbType);
        ...
        this._orbSmall.x = 233 + ((this._orbSmall.height - 2) * i);
    ...
    this.addBall = function(value) {
        ...
        this._orbSmall = new Phaser.Sprite(this._engine, 546, 218, 'assetfreegames2', orbTypeS);
        this._orbSmall.mask = this._sideBarMask;
        this._groupSideBar.addChild(this._orbSmall);
        this._sprBalls.push(this._orbSmall);

        this.removeOrbLarge();
        this._orbLarge = new Phaser.Sprite(this._engine, 519, 61, 'assetfreegames2', orbTypeL);
        this._orbLarge.scale.set(1.62,1.62);
        // this._orbLarge.anchor.setTo(0.5, 0.5);
        this._groupSideBar.addChild(this._orbLarge);

        this._orbFire = new Phaser.Sprite(this._engine, 449, 39, 'assetfreegames2', 'orbplace_fx_0000.png');
    ...
    this.tweenOrbDown = function() {
        ...
        this._tweenOrbPosition = this._engine.add.tween(this._orbSmall).to({
            ...
            x: 233 + ((this._orbSmall.height - 2) * (this._dataBalls.length - 1))
    ...
    this.gotoRedFlame = function(){
        ...
        this._redFlame = new Phaser.Sprite(this._engine,120,128,'assetfreegames2','orbdown_fx_0000.png');
        this._groupSideBar.add(this._redFlame);
    ...
    this.removeOrbSmall = function() {
        ...
        /*for (var i = 0; i < this._sprBalls.length; i++) {
            ...
            if (this._sprBalls.length > 0) {
                this._tweenOrbRemove = this._engine.add.tween(this._sprBalls[i]).to({
                    x: 1 * (this._orbSmall.height - 2) * i + (this._sideBar.y + 200)
    ...
    this.orbToPlace = function(){
        ...
        this._orbHand = new Phaser.Sprite(this._engine, 228, 218, 'assetfreegames2', orbTypeHand);
    ...
    this.orbInPlace = function(){
        ...
        this._blueFlame = new Phaser.Sprite(this._engine, 449, 39, 'assetfreegames2', 'orbplace_fx_0000.png');
    ...
    this.orbOnPlace = function(){
        ...
        this._orbPlace = new Phaser.Sprite(this._engine, 519, 61, 'assetfreegames2', orbTypePlace);
        // this._orbPlace.anchor.setTo(0.5,0.5);
        this._orbPlace.scale.set(1.62,1.62);
        this._groupSideBar.addChild(this._orbPlace);
