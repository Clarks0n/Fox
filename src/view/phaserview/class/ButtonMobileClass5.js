var buttonMobileClass = function(engine, group) {
    ...
    this.create = function() {
        ...
        for(var i=0;i<5;i++){
            ...
            this._betValueFrameBtn = this._engine.add.button(x, y, 'interface', null, this, "value-frame.png", "value-frame.png", "value-frame.png", null, this._grpBetValue);
            this._betValueFrameBtn.anchor.setTo(0.5, 0.5);
            this._betValueFrameBtn.index = i;
            this._betValueFrameBtn.events.onInputDown.add(this.btnClick, this, 0, "chooseBetValue");
  ...
  //////////////////////////////////////////////////////    
    ...
    this.createPortrait = function(){
      ...
      this._spinFrame.y = 1135; 
        ...
        // this._grpCoinsValue.x = -400;
        // this._grpCoinsValue.y = 400;
