var buttonClass3 = function(engine, group) {
    this._engine = engine;
    this._group = group;
    ...
    this.create = function() {
        ...
        // }
        this._valueSpinLeft = new Phaser.Text(this._engine, GlobalClass.getPosX(820), GlobalClass.getPosY(665), "", this._style2);
        this._valueSpinLeft.anchor.set(0, 0.5);
        this._grpFeature.addChild(this._valueSpinLeft);


        // COLUMN BOTTOM
        this._cashBalance = new Phaser.Text(this._engine, GlobalClass.getPosX(400), GlobalClass.getPosY(695), "Balance: " + GlobalClass.GAME_CURRENCY + " " + numeral(GlobalClass.GAME_BALANCE_CURRENCY).format('0,0.00'), this._style3);
        this._groupButton.addChild(this._cashBalance);

        this._cashBet = new Phaser.Text(this._engine, GlobalClass.getPosX(900), GlobalClass.getPosY(695), "Cash Bet: " + GlobalClass.GAME_CURRENCY + " " + numeral(GlobalClass.getCashBet()).format('0,0.00'), this._style3);
        this._groupButton.addChild(this._cashBet);

        this._valueWin = new Phaser.Text(this._engine, GlobalClass.getPosX(700), GlobalClass.getPosY(695), "Win: " + GlobalClass.GAME_CURRENCY + " " + numeral(0).format('0,0.00'), this._style3);
